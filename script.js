...
let multilineText=document.querySelector('.change');

function text_animation(){
    setTimeout(()=>{
        multilineText.innerHTML='web designing';
        multilineText.style.color='orange';
    }, 0);

    setTimeout(()=>{
        multilineText.innerHTML='web development';
        multilineText.style.color='brown';
    }, 4000);
 
    setTimeout(()=>{
        multilineText.innerHTML='Javascript softwares';
        multilineText.style.color='burlywood';
    }, 8000);

    setTimeout(()=>{
        multilineText.innerHTML='Web-related projects';
        multilineText.style.color='purple';
    }, 12000);

    setTimeout(()=>{
        multilineText.innerHTML='CSS stylings';
        multilineText.style.color='goldenrod';
    }, 16000);  
}

text_animation();
setInterval(text_animation,20000)
...
let imagesContents=[
    ...
    {
        img:"http://drive.google.com/uc?export=view&id=1cHiZqhaWF4OGhJt2Luu9Bb64Q2_0Im6h"
    },
    ...
    {
        img:"http://drive.google.com/uc?export=view&id=1ssBAsj_oTjLDE1j_j_suxWv1vUFnSQKj"
    },
